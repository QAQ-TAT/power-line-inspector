...
EXTERN_C DWORD VCI_DevRelayStatusSet(DWORD DevType,DWORD DevIndex,BYTE state1, BYTE state2);
EXTERN_C DWORD VCI_DevRelayStatusGet(DWORD DevType,DWORD DevIndex,BYTE *state1, BYTE *state2);
EXTERN_C DWORD VCI_DevBaudParaGet(DWORD DevType,DWORD DevIndex,DWORD CANIndex,BYTE* time0, BYTE* time1);
EXTERN_C DWORD VCI_DevChStateGet(DWORD DevType,DWORD DevIndex,DWORD CANIndex,BYTE* ctrlState, BYTE* txErrCnt, BYTE* rxErrCnt);
EXTERN_C DWORD VCI_DevDataTransfer(DWORD DevType,DWORD DevIndex, BYTE* data, int len);
